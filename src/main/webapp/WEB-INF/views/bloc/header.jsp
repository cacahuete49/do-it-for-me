...
<!-- Les eagster qui vont bien: 0xCAFEBABE, ... -->
<nav class="navbar navbar-default navbar-static-top">
	<div class="container">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="accueil">DoItForMe</a>
		</div>
		<div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav">
				<%--  class="active" --%>
				<li><a href="accueil">Accueil</a></li>
				<li><a href="accueil#ancre_contenu">Actu</a></li>
				<li><a
					href="https://play.google.com/store/apps/details?id=fr.k49.ChargeurScenarii"
					target="blank">Téléchargement</a></li>
							...
							<div class="dropdown-menu pull-right" style="padding: 17px;">
								<f:form class="form" modelAttribute="user" method="POST"
									...
									<c:if test="${ not empty error}">
										...
										<script>
											<%-- permet l'affichage automatique de la popup --%>
											$("#navLogin").click();
										</script>
									</c:if>
									<label>Email</label>
