...
<link rel="icon" type="image/png"
	href="<c:url value='/resources/img/ic_launcher.png' />" />
<link href="<c:url value='/resources/css/bootstrap.min.css' />"
	rel="stylesheet" />
<link href="<c:url value='/resources/css/dropdown-menu.css' />"
	rel="stylesheet">
...
<link href="<c:url value='/resources/css/signin.css' />"
	rel="stylesheet">
<link href="<c:url value='/resources/css/listeEtoile.css' />"
	rel="stylesheet">
<link href="<c:url value='/resources/css/custom.css' />"
	rel="stylesheet">
<script src="<c:url value='/resources/js/jquery-1.11.2.js' />"></script>
<script src="<c:url value='/resources/js/bootstrap.min.js' />"></script>
<script src="<c:url value='/resources/js/survole.js' />"></script>
<script src="<c:url value='/resources/js/ListeEtoile.js' />"></script>
</head>